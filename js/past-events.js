        ...
        <div class="col-lg-6">
          <div class="card mt-4">
            <div class="card-body">
              ...
              <div class="row mt-4">
                <div class="col">
                  <a href="https://tahoeanime.github.io/DPS-game-scheduler/event-detail-past.html?e=${eventKey}&game=${eventData.game}" class="btn btn-primary btn-block">View event</a>
                </div>
              </div>
            </div>
